...
namespace CoinService.DataLayer
{
	public static class Registration
	{
		...
		private static IServiceCollection AddDatabaseContext(this IServiceCollection services)
		{
			...
			services.AddDbContext<CoinServiceContext>(options =>
				options.UseNpgsql(configuration.GetConnectionString("CoinDB")), ServiceLifetime.Scoped);
		...
		{
			services.AddHealthChecks().AddDbContextCheck<CoinServiceContext>();
